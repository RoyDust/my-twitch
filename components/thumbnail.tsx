...
export const Thumbnail = ({
  ...
  if (!src) {
    content = (
      <div className=" gap-y-4 bg-background group-hover:-translate-y-1 group-hover:translate-x-2 flex flex-col items-center justify-center w-full h-full transition-transform rounded-md">
        <UserAvatar
          size="lg"
          showBadge
          username={username}
